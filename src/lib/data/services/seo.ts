...
export const seo: Service = /* ------------------------------------------------------------------ */
  {
    ...
    hero: {
      ...
      sub:
        "We build SEO strategies that improve your visibility across search engines, AI platforms and the places your customers look for trusted answers.",
    },
    ...
    capabilities: [
      ...
      { icon: ShoppingCart, title: "E-commerce SEO", body: "Product, category and technical optimisation designed to improve visibility and conversions." },
    ...
    seo: {
      ...
      title: "SEO Services, AEO & GEO Strategy",
      description:
        "Grow your search visibility with SEO, AEO and GEO strategies that increase rankings, AI visibility, traffic and qualified leads.",
      ogTitle: "SEO, AEO & GEO Built for Business Growth",
      ogDescription:
        "Improve your visibility across Google and AI search with SEO, AEO and GEO strategies built to attract qualified traffic and leads.",
    ...
    problem: {
      title: "Not sure why you are not appearing in AI searches?",
    ...
    testimonials: [],
    /* Not in the brief; left as found. It renders as a factual claim. */
  };
